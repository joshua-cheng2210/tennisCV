...
def draw_player_stats(output_video_frames,player_stats, p1_id, p2_id):

    for index, row in player_stats.iterrows():
        player_1_shot_speed = row[f'player_{p1_id}_last_shot_speed']
        player_2_shot_speed = row[f'player_{p2_id}_last_shot_speed']
        player_1_speed = row[f'player_{p1_id}_last_player_speed']
        player_2_speed = row[f'player_{p2_id}_last_player_speed']

        avg_player_1_shot_speed = row[f'player_{p1_id}_average_shot_speed']
        avg_player_2_shot_speed = row[f'player_{p2_id}_average_shot_speed']
        avg_player_1_speed = row[f'player_{p1_id}_average_player_speed']
        avg_player_2_speed = row[f'player_{p2_id}_average_player_speed']
